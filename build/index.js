(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sharingan"] = factory();
	else
		root["sharingan"] = factory();
})(this, function() {
...
var sharingan = function () {
    function sharingan(config) {
        _classCallCheck(this, sharingan);
        ...
        value: function _catch(cb) {
            ...
            element && (0, _html2canvas2.default)(element, {
                ...
                onrendered: function onrendered(canvas) {
                    ...
                    var source = obj.getImageData(0, 0, canvas.width, canvas.height);
                    arr.push(source);
